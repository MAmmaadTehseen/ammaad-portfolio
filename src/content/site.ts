...
export const services: { title: string; body: string; proof: string[] }[] = [
  ...
  },
  {
    ...
    proof: ["oncology-trial-matcher", "algoricum", "ai-labs"],
  },
  {
    ...
    proof: ["ai-meeting-platform", "discover-live", "employee-milestones"],
  },
  {
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "AI Meeting Management & Automation",
    tier: "closed",
    depth: "showcase",
    featured: true,
    year: "2025",
    ...
    lede: {
      client:
        "Meetings end to end, across two engagements: a workspace that runs a team's meetings — scheduling, agendas, minutes and attendance — and, for Little Tree Confections, an automation that turns every recorded meeting into assigned, prioritised tasks and a CEO dashboard that is already current.",
      recruiter:
        "Tech lead on a multi-tenant meeting SaaS integrating Zoom, Google Meet and WhatsApp, owning the AI features and the Google integrations; and automation engineer on the n8n workflows that turn meeting data into structured ClickUp and Notion tasks.",
      engineer:
        "Both halves put a model where a decision is, not where the work is: the assistant decides whether a conversation needs a meeting or just an email, and the agent returns structured output rather than prose, so every downstream node parses instead of guessing.",
    },
    stack: [
      "Zoom",
      "Google Meet",
    ...
    outcomes: [
      ...
      "No note-taking or task entry after a meeting: every action item lands in the right list with an owner, a due date and a link back to the notes",
    ...
    internals: [
      ...
      "Tasks fan out to department lists, the CEO master list and the project list, each back-linked to its meeting page",
      "The daily scan finds CEO-related work by assignment, mention or unresolved comment across every space, subtasks included",
    ...
    flow: {
      nodes: [
        ...
        { id: "tasks", label: "ClickUp · Notion", sub: "tasks · pages", col: 5, row: 3, kind: "store" },
      ],
      edges: [
        ...
        { from: "minutes", to: "tasks", label: "tasks" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    links: [{ label: "Preview environment", href: "https://dev.labs.firstmovers.ai/" }],
    outcomes: [
